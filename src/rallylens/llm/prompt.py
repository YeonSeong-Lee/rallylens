...
- shuttle: 셔틀 관련 수치
  ...
  - rally_count / longest_rally_shots / avg_rally_shots: 랠리 경계는 연속 접촉 간격
    2초 초과 휴리스틱으로 추정된 값
...
3. 랠리 수는 휴리스틱 추정치이므로 "정확히 N 랠리"보다는 "약 N 개의 랠리로 나뉘며"
   또는 "N 랠리 정도로 추정됩니다" 같은 신중한 표현을 사용할 것.
4. 서브·득점 이벤트는 데이터에 없으니 언급 금지.
